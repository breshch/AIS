...
namespace AVRepository
{
	...
	public interface IAVBusinessLayer
	{
		...
		[OperationContract]
		DirectoryTypeOfPost[] GetDirectoryTypeOfPosts();

		[OperationContract]
		DirectoryTypeOfPost AddDirectoryTypeOfPost(string directoryTypeOfPostName);

		[OperationContract]
		void RemoveDirectoryTypeOfPost(int directoryTypeOfPostId);

		[OperationContract]
		DirectoryTypeOfPost GetDirectoryTypeOfPost(int workerId, DateTime date);
		...
		[OperationContract]
		DirectoryPost AddDirectoryPost(string name, DirectoryTypeOfPost typeOfPost, DirectoryCompany company,
			List<DirectoryPostSalary> postSalaries);

		[OperationContract]
		DirectoryPost EditDirectoryPost(int postId, string name, DirectoryTypeOfPost typeOfPost,
		...
		DirectoryUser[] GetDirectoryUsers();
