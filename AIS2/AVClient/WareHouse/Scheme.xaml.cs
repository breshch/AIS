...
namespace AVClient.WareHouse
{
	...
	public partial class Scheme : Window
	{
		...
		private bool _isPalletSelected;
		...
		public Scheme()
		{
			...
			_carParts = bc.GetDirectoryCarParts().ToArray();
		...
		private void InitializeWarehouse()
		{
			...
			var palletContents = bc.GetAllPallets(_schemeData.WarehouseName);
		...
		private void DrawTableArticlesInPallet(SchemeCell cell)
		{
			...
			buttonSave.Click += (sender, e) =>
			{
				...
				var palletContents =bc.SavePalletContents(_schemeData.WarehouseName, address, carPartPallets.ToArray());
