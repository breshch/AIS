...
namespace AVClient.Reports
{
    public static class CarPartReports
    {
        ...
        public static void ComplitedLoanRemainsToDate( DateTime date)
        {
            ...
            Helpers.CompletedReport(path, new List<Action<ExcelPackage>>
                {
                    ep => LoanRemainsToDate(ep, date)
                });
        }

        private static void LoanRemainsToDate(ExcelPackage ep, DateTime date)
        {
