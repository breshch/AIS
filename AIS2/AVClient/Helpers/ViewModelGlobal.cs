...
{
    public class ViewModelGlobal : PropertyChangedBase, IDataErrorInfo
    {
		protected AVBusinessLayerClient BC = ServerConnector.GetInstanse;
        ...
        {
            var properties = GetType().GetProperties().Where(p => p.CustomAttributes.Any());
