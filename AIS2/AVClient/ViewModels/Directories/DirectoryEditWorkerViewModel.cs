...
namespace AVClient.ViewModels.Directories
{
    public class DirectoryEditWorkerViewModel : DirectoryWorkerBaseViewModel
    {
        ...
        {
            _selectedDirectoryWorker = BC.GetDirectoryWorkerById(workerId);

            IsFireWorkerEnable = HelperMethods.IsPrivilege(UserPrivileges.Workers_FireWorkers);
        ...
        private void EditWorker(object parameter)
        {
            ...
            BC.EditDirectoryWorker(_selectedDirectoryWorker.Id, DirectoryWorkerLastName, DirectoryWorkerFirstName, DirectoryWorkerMidName, DirectoryWorkerGender, SelectedDirectoryWorkerBirthDay, DirectoryWorkerAddress,
                DirectoryWorkerHomePhone, DirectoryWorkerCellPhone, SelectedDirectoryWorkerStartDate, Photo, SelectedDirectoryWorkerFireDate, CurrentCompaniesAndPosts.ToArray(), IsDeadSpirit);
