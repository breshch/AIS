...
namespace AVClient.ViewModels
{
    public class MainProjectChoiseViewModel : ViewModelGlobal
    {
        ...
        public MainProjectChoiseViewModel()
        {
            ...
            if (Privileges.UserPrivileges.Contains(UserPrivileges.MultyProject_MonthTimeSheetEnable.ToString()))
            {
                IsEnabledMonthTimeSheet = true;
            }

            if (Privileges.UserPrivileges.Contains(UserPrivileges.MultyProject_DbFenoxEnable.ToString()))
            {
